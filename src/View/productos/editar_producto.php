...
<body class="fondo">
 <nav class="navbar fixed-top navbar-expand-lg">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown hover-bg">
                  ...
                  <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="../vistasAdmin/vistaGestionProductos.php">Volver</a></li>
  ...
  <div class="container">
    ...
    <div class="container">
            <div class="col-md-8 bg-black d-block mx-auto mt-4">
                <div class="card mb-5">
                    <?php
                    if(isset($_GET['id'])){
                        $id = $_GET['id'];
                        // mostrar los productos por id en el placeholder
                        include '../../controller/productos/procesar_productos.php';
                        $controlador = new ProcesarProductos();
                        $productos = $controlador->procesarMostrarProductosPorId($id);
                    }
                    ?>

                    <?php foreach ($productos as $producto): ?>

                   <form action="../../../src/controller/productos/procesar_productos.php" method="POST" class="p-4" enctype="multipart/form-data">
                    <h4 class = "text-center">Editar Producto</h4>
                      <div class="mb-4">
                         <label for="" class="form-label">Nombre del Producto:</label>
                         <input type="text" class="form-control" id="titulo" name="titulo" placeholder="<?php echo $producto['titulo']; ?>" required>   
                      </div>
                      <div class="mb-4">
                         <label for="descripcion" class="form-label">Descripción:</label>
                         <textarea class="form-control" id="" cols="30" rows="4" name="descripcion" id="descripcion" placeholder="<?php echo $producto['descripcion']; ?>" required></textarea>
                      </div>
                      <div class="mb-4">
                         <label for="precio" class="form-label">Precio:</label>
                         <input type="text" class="form-control" name="precio" id="precio" placeholder="<?php echo $producto['precio']; ?>" required> 
                      </div>
                      <div class="mb-4">
                        <label for="fecha">Fecha:</label>
                        <input type="date" name="fecha" value="<?php echo date('Y-m-d'); ?>" id="fecha" class="form-control" required>
                      </div> 
                      <?php endforeach; ?>
                      <div class="mb-4">
                            ...
                            <select name="categoria_id" id="categoria_id" class="form-control" required>
                                ...
                                <!-- mostrar categorías -->
                                <?php include '../../controller/categorias/procesar_categorias.php';
                                $controlador = new ControladorCategorias();
                                $categorias = $controlador->mostrarCategorias();
                      ...
                      <div class="mb-4">
                          <label for="ruta_archivo" class="form-label">Foto:</label>
                          <input type="file" name="ruta_archivo" id="ruta_archivo" class="form-control" required>
                      </div> 
                      <!-- se agrega campo oculto para indicar la acción al archivo controlador y seleccionar la acción en el condicional-->
