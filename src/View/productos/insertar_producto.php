...
<head>
    ...
    <title>Insertar Productos | OriTech</title>
            ...
            <div class="col-md-6 bg-black d-block mx-auto mt-4">
                <div class="card mb-5">
                   <form action="../../../src/controller/productos/procesar_productos.php" method="POST" class="p-4" enctype="multipart/form-data"> 
                    <h4 class = "text-center">Añadir Nuevo Producto</h4>
                      <div class="mb-4">
                      ...
                      <div class="mb-4">
                         ...
                         <textarea class="form-control" cols="30" rows="4" name="descripcion" id="descripcion" required></textarea>
                      </div>
                      <div class="mb-4">
