...
<head>
    ...
    <title>Editar Categorías | OriTech</title>
...
<body class="fondo">
  ...
  <div class="container">
    ...
    <div class="container">
        <h3 class="mt-4 text-light">Editar Categoría</h3>
        <div class="col-md-6 bg-black d-block mx-auto mt-4">
            <div class="card">
                <?php
                if (isset($_GET['editar_categoria'])) {
                    $categoriaId = $_GET['editar_categoria'];
                    require '../../Controller/categorias/procesar_categorias.php';
                    $controller = new ControladorCategorias();
                    $categoria = $controller->mostrarCategoriaPorId($categoriaId);
                }
                ?>
                <form action="../../Controller/categorias/procesar_categorias.php" method="POST" class="p-4" enctype="multipart/form-data">
                    <h4 class="text-center">Editar</h4>
                    <div class="mb-4">
                        <label for="nombre" class="form-label">Nombre:</label>  
                        <input type="text" class="form-control" value="<?php echo $categoria['nombre']; ?>" name="nombre" id="nombre" required>
