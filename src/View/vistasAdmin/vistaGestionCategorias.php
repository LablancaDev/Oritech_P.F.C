...
<head>
    ...
    <title>Gestión Categorías | OriTech</title>
            ...
            <div class="col-md-12">
                <fieldset>
                    <div class="d-flex align-items-center">
                        <legend class="text-light">Gestión de Categorías</legend>
                        <a href="../categorias/insertar_categorias.php" class="text-decoration-none">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-primary table-hover">
                            ...
                            <tbody id="mostrar_productos">
                                <?php
                                require '../../Controller/categorias/procesar_categorias.php';
                                ...
                                <?php foreach($categorias as $categoria):?>
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <a href="../categorias/editar_categoria.php?editar_categoria=<?php echo $categoria['id']?>"><button class="btn btn-primary"><i class="bi bi-pencil-square"></i></button></a>
                                            <a href="../../Controller/categorias/procesar_categorias.php?eliminar_categoria=<?php echo $categoria['id']?>"><button class="btn btn-danger"><i class="bi bi-trash3"></i></button></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
